...
public class jdbc_db 
{
   ...
   public void initDatabase() throws SQLException 
   {
      ...
      insert("Course", "'MUSC', 1334, 'Music Appreciation', 4");
      insert("Course", "'MUSC', 2456, 'Vocal Lessons', 3");
      insert("Course", "'CSCE', 4532, 'Programming Foundations', 4");
      insert("Course", "'MUSC', 2313, 'Piano', 4");
      insert("Course", "'MATH', 3546, 'Algebra 2', 4");
